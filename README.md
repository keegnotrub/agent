...
agent is a set of zshell scripts (`chat` and `fim`) for interfacing with Mistral's [Codestral](https://mistral.ai/news/codestral-2501) both chat and fill in the middle code completion.
